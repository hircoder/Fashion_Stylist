...
KEYWORDS = [
    "swim trunks", "bikini", "one piece swimsuit", "flip flops", "sandals", "sun hat",
    "sunglasses", "linen shirt", "beach cover up", "snow boots", "winter gloves", "scarf",
    "beanie", "ear warmers", "puffer jacket", "wool sweater", "chino pants", "dress shirt",
    "blazer", "pencil skirt", "running shoes", "rain jacket", "hiking boots", "cocktail dress",
    "leggings", "hoodie", "socks", "belt", "wallet", "backpack",
]
PER_KEYWORD = 3
STRATIFIED = 400
SEED = 42
